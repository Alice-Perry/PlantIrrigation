...
public class PlantFactory {
    ...
    private String getPlantType(Scanner scanner) {
        ...
        if (plantType.equalsIgnoreCase("") || plantType.equalsIgnoreCase(" ")) {
            System.out.println("That is not a legal input. Please try again.");
            getPlantType(scanner);
        }
        return plantType;
    }
    ...
    private int getMoistureLevel(Scanner scanner) {
        ...
        try {
            ...
            System.out.println("Characters were used.");
            scanner.nextLine();
        }
    ...
    public String displayPlantDetails(Plant plant , FrequencyCalculator frequencyCalculator , AmountOfWaterCalculator amountOfWaterCalculator , WaterGiver waterGiver) {
        ...
        return
         "\n\nGREENLEAF WATERING SYSTEMS IS WORKING FOR YOU. \n\n" +
          ...
          "Your plant will be watered " + amountOfWaterCalculator.calculateAmountOfWater(plant) + " milliliter for every "
